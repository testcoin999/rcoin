...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 144;
...
const uint64_t EXPECTED_NUMBER_OF_BLOCKS_PER_DAY             = 4320;
const size_t   DIFFICULTY_WINDOW                                = 17;
const size_t   DIFFICULTY_WINDOW_V1                          = 4320;
const size_t   DIFFICULTY_WINDOW_V2                          = 4320;
...
const char     CRYPTONOTE_NAME[]                             = "rcoinx2a";
...
const int      P2P_DEFAULT_PORT                              =  7990;
const int      RPC_DEFAULT_PORT                              =  7991;
...
const char* const SEED_NODES[] = { "127.0.0.1:7990", "73.137.75.34:7990" };
